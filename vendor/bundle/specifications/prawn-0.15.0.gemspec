...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      s.add_runtime_dependency(%q<ttfunk>.freeze, ["~> 1.1.0"])
      s.add_runtime_dependency(%q<pdf-core>.freeze, ["~> 0.1.3"])
      s.add_development_dependency(%q<pdf-inspector>.freeze, ["~> 1.1.0"])
      s.add_development_dependency(%q<coderay>.freeze, ["~> 1.0.7"])
      ...
      s.add_dependency(%q<ttfunk>.freeze, ["~> 1.1.0"])
      s.add_dependency(%q<pdf-core>.freeze, ["~> 0.1.3"])
      s.add_dependency(%q<pdf-inspector>.freeze, ["~> 1.1.0"])
      s.add_dependency(%q<coderay>.freeze, ["~> 1.0.7"])
